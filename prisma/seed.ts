...
const moviesArray = [
    {
        ...
        description: "A rising wave of crime in Gotham forces Batman to confront the Joker, a chaotic mastermind who pushes the city - and Batman - to their moral limits.",
        price: 169,
        releaseDate: 2008,
    ...
    {
        title: "Pulp Fiction",
        description: "Interwoven stories follow hitmen, a boxer, and a crime boss’s wife as their lives collide in a darkly comic, violent, and stylish series of twists.",
        price: 79,
        releaseDate: 1994,
    ...
    {
        title: "Inception",
        description: "A skilled thief who steals secrets through dream‑sharing technology is offered a chance at redemption if he can plant an idea deep inside a target’s subconscious.",
        price: 169,
        releaseDate: 2010,
    ...
    {
        title: "Forrest Gump",
        description: "A kind‑hearted man with a simple outlook unwittingly influences major historical events while pursuing his lifelong love, Jenny.",
        price: 79,
        releaseDate: 1994,
    ...
    {
        title: "The Matrix",
        description: "A hacker discovers that reality is a simulated world controlled by machines, and joins a rebellion to free humanity from the illusion.",
        price: 79,
        releaseDate: 1999,
        imageUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/1/1c/The_Dark_Knight_%282008_film%29.jpg/250px-The_Dark_Knight_%282008_film%29.jpg",
        runtime: 136,
